      ...
      <div className="max-w-[400px] w-full text-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          <input
            ...
            autoFocus
            className="w-full h-12 px-5 rounded-full border border-black/10 bg-white text-[14px] text-[#151515] text-center font-mono tracking-[0.1em] placeholder:text-[#151515]/25 placeholder:font-sans placeholder:tracking-normal focus:outline-none focus:border-[#111111] transition-colors"
          />
          <button
            type="submit"
            disabled={loading || !value.trim()}
            className="w-full h-12 rounded-full bg-[#151515] text-white text-[14px] font-medium hover:bg-[#333333] transition-colors disabled:opacity-40 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2"
          >
